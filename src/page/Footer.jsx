...
const Footer = () => {
    return (
        <div className='border-t-2'>
            <footer className="footer p-10  text-base-content container m-auto">
                <nav>
                    <h1 className='text-2xl text-green-500 font-bold'>Elite Clean Experts</h1>
                    <h1>Elite Clean Experts</h1>
                </nav>
                <nav>
                ...
                <footer className="footer px-10 py-4 border-t t text-white border-base-300 container  m-auto">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Elite Clean Experts <br/>Providing reliable tech since 1992</p>
                </aside> 
